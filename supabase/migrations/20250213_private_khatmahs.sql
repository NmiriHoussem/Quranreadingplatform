-- =====================================================
-- PRIVATE KHATMAHS DATABASE SCHEMA
-- =====================================================
...
-- Private Khatmah Members Policies
-- Users can view members of khatmahs they're part of
  ...
  USING (
    EXISTS (
      ...
      AND (created_by = auth.uid() OR EXISTS (
        SELECT 1 FROM public.private_khatmah_members m2
        WHERE m2.khatmah_id = id 
