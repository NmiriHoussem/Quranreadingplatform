...
import { Brain, ArrowLeft, Users, Target, Moon, Sun, Globe, Plus, CheckCircle2 } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-50 to-white dark:from-purple-950 dark:to-purple-900">
        ...
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <div className="flex gap-2 items-center">
            <Button 
              variant="outline" 
              size="icon"
              className="border-purple-600 dark:border-purple-500 text-purple-600 dark:text-purple-400 hover:bg-purple-50 dark:hover:bg-purple-900"
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <Card className="p-6 mb-8 border-purple-100 dark:border-purple-800 dark:bg-purple-950/50">
          <h2 className="text-xl text-purple-900 dark:text-purple-100 mb-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-2xl text-purple-900 dark:text-purple-100">{memorizationGroups.length}</div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-2xl text-purple-900 dark:text-purple-100">{totalMemorized}</div>
                <div className="text-sm text-purple-600 dark:text-purple-400">
                  {language === 'ar' ? 'آيات محفوظة' : 'Verses Memorized'}
                </div>
              </div>
            </div>
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-2xl text-purple-900 dark:text-purple-100">{overallProgress}%</div>
                <div className="text-sm text-purple-600 dark:text-purple-400">
              ...
              <div className="flex justify-between text-sm text-purple-600 dark:text-purple-400">
                ...
                {totalNeedReview > 0 && (
                  <span className="text-amber-600 dark:text-amber-400">
                    {totalNeedReview} {language === 'ar' ? 'تحتاج مراجعة' : 'need review'}
                  </span>
                )}
              </div>
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-2xl text-purple-900 dark:text-purple-100">
              {language === 'ar' ? 'مجموعات الحفظ' : 'Your Memorization Groups'}
            </h2>
            <Link to="/groups?filter=memorization&tab=discover">
              <Button variant="outline" size="sm" className="border-purple-600 dark:border-purple-500 text-purple-600 dark:text-purple-400 hover:bg-purple-50 dark:hover:bg-purple-900">
          ...
          {surahs.length > 0 ? (
            <div className="grid gap-4">
              {surahs.map((surah: any) => (
                ...
                >
                  <Card className="p-6 border-purple-100 dark:border-purple-800 dark:bg-purple-950/50 hover:border-purple-400 dark:hover:border-purple-600 transition-all">
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-1">
                          <h3 className="text-lg text-purple-900 dark:text-purple-100">
                        ...
                        {surah.needsReview > 0 && (
                          <p className="text-xs text-amber-600 dark:text-amber-400 mt-1">
                            {surah.needsReview} {language === 'ar' ? 'آيات تحتاج مراجعة' : 'verses need review'}
                          </p>
                        )}
                      </div>
                    ...
                    <Progress value={surah.percentComplete} className="h-2 mb-4" />
                    ...
                    <div className="flex gap-2">
                      ...
                      >
                        {surah.percentComplete > 0 
                          ? (language === 'ar' ? 'متابعة الحفظ' : 'Continue Memorizing')
                          : (language === 'ar' ? 'ابدأ الحفظ' : 'Start Memorizing')
                        }
                      </Button>
                      {surah.needsReview > 0 && (
                        <Button 
                          variant="outline"
                          className="border-amber-600 dark:border-amber-500 text-amber-600 dark:text-amber-400 hover:bg-amber-50 dark:hover:bg-amber-900/20"
                          onClick={(e) => {
                            e.preventDefault();
            ...
            <Card className="p-8 border-purple-100 dark:border-purple-800 bg-purple-50 dark:bg-purple-900/30 text-center">
              <div className="w-16 h-16 rounded-full bg-purple-100 dark:bg-purple-900/50 flex items-center justify-center mx-auto mb-4">
                <Brain className="w-8 h-8 text-purple-600 dark:text-purple-400" />
              </div>
              <h3 className="text-lg text-purple-900 dark:text-purple-100 mb-2">
              ...
              <p className="text-purple-600 dark:text-purple-400 mb-6">
                {language === 'ar' 
                  ...
                  : 'Join a memorization group to start your hifdh journey'}
              </p>
              <Link to="/groups?filter=memorization&tab=discover">
        ...
        {/* Features Info */}
        <Card className="p-6 border-purple-100 dark:border-purple-800 dark:bg-purple-950/50">
          <h3 className="text-lg text-purple-900 dark:text-purple-100 mb-3">
