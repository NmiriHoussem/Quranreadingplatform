                ...
                <div className="space-y-2">
                  {allChapters.map((chapter) => (
                    <button
                      ...
                      className="w-full text-left p-4 rounded-lg border border-emerald-100 dark:border-emerald-800 hover:bg-emerald-50 dark:hover:bg-emerald-900 transition-colors"
                    >
                      <div className="flex justify-between items-center">
                        <div>
                          <div className="text-emerald-900 dark:text-emerald-100">
